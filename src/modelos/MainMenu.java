...
import conversor.modelos.TasaConversor;
...
public class MainMenu {
    ...
    public void mainMenu() {
        ...
        do {
            System.out.println("-----------------------------");
            System.out.println("Bienvenido al conversor de moneda [$̲̅(̲̲̅̅̅)̲̅$̲̅]");
    ...
    public MainMenu(conversor.modelos.Connection connection, Gson gson) {
